...
TRACKED_LEAGUES = ["ENGLISH LEAGUE ONE", "LEAGUE TWO", "DUTCH EERSTE DIVISIE", "MAJOR LEAGUE SOCCER (MLS)", "BRAZILEIRAO SERIE A (BRAZIL)", "LIGA MX (MEXICO)", "LIGA PROFESSIONAL(ARGENTINA)"]
